...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Control de Tiempo de Mantenimientos</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tiempo de Mantenimientos</h4>
    </div>
	...
	<form role="form" id="frmItem" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Tipo</label>
                <input class="form-control" id="tip" style="width:50%" size="1" maxlength="1">
            </div>            
        </form>
    </div>
...
//        });
    ...
    function deleteItem(id){
        $.ajax({
            ...
            datatype:'json',
            data: "id=" + id,
            url:base_url+"configuracion/tiempoMant/delete",
            success : function(text){
                console.log(text);
                var data = $.parseJSON(text);            
                $.msgBox({
        ...
        function create(){
            ...
            if (nombre.trim()==='' ) {
                ...
                cache:false,
                data: data,
                url:base_url+"configuracion/tiempoMant/create",
                success : function(text){
                    var data = $.parseJSON(text);                                        
                    if (data.success){
                        $('#btnCerrar').click();
