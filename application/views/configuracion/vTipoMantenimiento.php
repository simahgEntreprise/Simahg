...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tipos de Mantenimiento</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tipos de Mantenimiento</h4>
    </div>
...
//        });
    ...
    function deleteItem(id){
        $.ajax({
            ...
            datatype:'json',
            data: "id=" + id,
            url:base_url+"configuracion/tipoMant/delete",
            success : function(text){
                console.log(text);
                var data = $.parseJSON(text);            
                $.msgBox({
        ...
        function create(){
            ...
            if (nombre.trim()==='' ) {
                ...
                cache:false,
                data: data,
                url:base_url+"configuracion/tipoMant/create",
                success : function(text){
                    var data = $.parseJSON(text);                                        
                    if (data.success){
                        $('#btnCerrar').click();
