...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Maestro de Empresas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Maestro de Empresas</h4>
    </div>
    <div class="modal-body">
	<form role="form" id="frmItem" enctype="multipart/form-data">
            <div class="form-group">
                <label>Numero RUC</label>
                <input class="form-control" id="ruc" style="width:50%" size="11" maxlength="11">
            </div>            
            <div class="form-group">
                <label>Razon social</label>
                <input class="form-control" id="nom" style="width:50%" size="100" maxlength="100">
            </div>            
            <div class="form-group">
                <label>Representante Legal</label>
                <input class="form-control" id="rpt" style="width:50%" size="100" maxlength="100">
            </div>            
        </form>
    </div>
    ...
    function deleteItem(id){
        ...
        function create(){
            ...
            if (nombre.trim()==='' ) {
                ...
                data.append('ruc',nrruc);
                data.append('represent',repre);
                ...
                cache:false,
                data: data,
                url:base_url+"configuracion/empresa/create",
                success : function(text){
                    var data = $.parseJSON(text);                                        
                    if (data.success){
                        $('#btnCerrar').click();
