...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Enlazar EPP - Cargo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">                                               
                        <div class="panel-body">                                                        
                            ...
                            <button type="button" class="btn btn-default"  id="btnGrabar" onclick="ctrItem();">Grabar</button>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
    ...
    $('#cboCargo').on('change', function(){
        var source =
            {                               
                url: base_url+"epp/enlaceEppCargo/getList?cargo="+this.value,
		...
		height: "100%",                
                ...
                columns: [
                  ...
                  { text: 'Accion', dataField: 'checked',  width: '10%', cellsalign: 'center', align: 'center', columntype: 'checkbox'},
        ...
        function ctrItem(){            
            ...
            $.ajax({
                ...
                url:base_url+"epp/enlaceEppCargo/create",
                success : function(text){
                    var data = $.parseJSON(text);                                        
                    if (data.success){
                        $('#btnCerrar').click();
